 ...
 */
 function typewrite()
 {
     let str="每个音符，都是我为你写下的一句情诗。<<而每句诗词也因为你的存在，有了声音。<<陈玲小可爱，元宵节快乐！<<";//利用<作为换行符 -作为空格
     let strp="";
     let i=0;
     function print1()
     {
...
let clickb=false;//判断播放按钮是否已经按过了，如果已经按过了才可以执行键盘事件
 ...
 let a=[
     {name:"A",yin:8, str:"<br><br><br>我想和你互相浪费<br>一起虚度短的沉默<br>长的无意义<br>一起消磨精致而苍老的宇宙<br><br>还有其他的键<br><br>那些都是关于你的声音。以及，找一下声音里关于你的线索。"},
     {name:"B" ,yin:2, str:`<br><br><br>若逢新雪初霁，满月当空<br>下面平铺着皓影，上面流转着亮银，<br><br>而你带笑地向我走来，<br><br>月色和雪色之间 ，是第三种绝色 ，<br><br>与我而言， 日月星辉之中，你是第四种难得。`},
     {name:"C" ,yin:8, str:"<br><br><br><br>我总是想些无关紧要的事<br><br>比如宇宙的目的，熬夜与猝死的关系<br><br>你是否曾爱我"},
     ...
     {name:"U" ,yin:3, str:"<br><br>我把我整个的灵魂都给你，<br><br>连同它的怪癖，耍小脾气，忽明忽暗，<br><br>一千八百种坏毛病， 它真讨厌。只有一点好， 爱你"},
 ...
 function fl(e)
 {
     ...
     if((key<='z'&&key>='a')||(key<='Z'&&key>='A'))//避免大小写的错误
     {
         ...
         if(s.indexOf("XIAOCLXIAOCLWXHN")!=-1&&records==0)
         {
             setTimeout(function()
             {
                 records=1;
